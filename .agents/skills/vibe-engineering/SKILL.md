...
> Vibe coding hatalarını kes; bitmiş özellik üret. DoD fail = task fail (AGENTS.md).
...
| Kalıp | Belirti | Önlem |
|---|---|---|
| **Context Collapse** | Önceki karara aykırı kod | Session başında AGENTS.md |
...
*AGENTS.md Integration DoD bağlayıcıdır. Fast-path'te ağır gate yok.*
