...
export default function GirisPage() {
  ...
  return (
    ...
    >
      ...
      {showLogin ? (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-4 w-full max-w-md aria-busy={gonderiliyor}">
          ...
          <button
            ...
            className="owner-button-primary w-full mt-2"
          >
      ...
      <button
        ...
        className="owner-button-secondary w-full mt-4 flex items-center justify-center gap-2"
      >
