...
export function MarketplaceEditor({ slug, links, onClose }: Props) {
    ...
    <div className="fixed inset-0 z-[90] flex items-end sm:items-center justify-center bg-black/60" onClick={onClose}>
      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-white/10 bg-[#0B1120] px-5 py-4">
          <div>
            <h2 className="text-lg font-extrabold text-white">Pazaryeri Bağlantıları</h2>
            <p className="text-[11px] text-white/40">Trendyol, Hepsiburada gibi linklerini ekle. Boş olanlar kaydedilmez.</p>
          </div>
