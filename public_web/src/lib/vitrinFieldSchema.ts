...
export const VITRIN_CONCEPTS: readonly VitrinConceptMeta[] = [
  ...
  { id: "urunHizmet", etiket: "Ürün / hizmet bölümü", aciklama: "Ürünlerin kendisini değil, vitrindeki bölüm başlıklarını düzenler", soru: "Kategori ve ürün bölümü başlıklarından hangisini değiştirelim?", esAnlamlar: ["ürün ve hizmet bölümüm", "ürünlerim ve hizmetlerim", "ürün hizmet bölümü", "katalog görünümü"] },
  ...
  { id: "galerim", etiket: "Galeri bölümü", aciklama: "Galeri görsellerini değil, bölüm başlık ve bağlantısını düzenler", soru: "Galeri başlığını mı, buton yazısını mı, bağlantısını mı değiştirelim?", esAnlamlar: ["galerimi düzenle", "galeri bilgilerim", "galerim", "fotoğraf galerim"] },
  { id: "yazilarim", etiket: "Yazılar bölümü", aciklama: "Yazıların kendisini değil, vitrindeki bölüm başlıklarını düzenler", soru: "Yazılar bölümünün üst başlığını mı, ana başlığını mı değiştirelim?", esAnlamlar: ["yazılarımı düzenle", "blog görünümü", "yazılar bölümüm", "yazılarım"] },
  { id: "sss", etiket: "Sık sorulanlar bölümü", aciklama: "SSS maddelerini değil, bölüm başlık ve açıklamasını düzenler", soru: "Sık sorulanlar bölümünün başlığını mı, üst yazısını mı, açıklamasını mı değiştirelim?", esAnlamlar: ["sık sorulanlar", "sıkça sorulan sorular", "sss bölümüm", "sorular bölümü"] },
];
