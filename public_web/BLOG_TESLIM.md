# Vixrex Blog — araştırma, tasarım ve teslim
...
Çalışma ortamında: `http://127.0.0.1:3107/blog`. Normal üretim derlemesi kapalı yayın davranışıyla kontrol edildi. Main birleştirmesi ve canlı dağıtım yapılmadı. Yayın kararı kullanıcı incelemesini bekliyor.

## Kabul kontrolleri

- Blog sözleşme testleri: `blog-kesif-ve-yayin-ilkeleri`, `blog-seo`, `blog-editor-page-contract`, `blog-yayin-anahtari` başarılı.
- Gerçek Chromium: `public_web/e2e/blog.spec.ts` içinde masaüstü arama/filtre/sıfırlama, 320px ve 390px taşma/içindekiler, altı yazı, metadata, RSS, OG PNG, 404, kopyalama ve hata geri bildirimi testleri.
