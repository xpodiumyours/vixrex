...
(
  ...
  'Kullanım Şartları',
  'VixRex platform kullanım kuralları.',
  '[{"title":"Platform Niteliği","body":"VixRex, kullanıcıların kendi mağaza, ürün, hizmet, iletişim ve görsel içeriklerini dijital vitrin olarak yayınlayabildiği bir platformdur."},{"title":"Kullanıcı Sorumluluğu","body":"Kullanıcı tarafından eklenen ürün, hizmet, fiyat, açıklama, stok, görsel, marka, bağlantı, kampanya ve iletişim bilgilerinin doğruluğu, güncelliği ve hukuka uygunluğu ilgili kullanıcıya aittir."},{"title":"Sorumluluk Sınırı","body":"VixRex, kullanıcı içeriklerine dayalı iletişimlerden, satışlardan, randevulardan, üçüncü taraf bağlantılardan veya mağaza sahibinin beyanlarından sorumlu tutulamaz."},{"title":"İçerik Denetimi","body":"VixRex, hukuka veya platform kurallarına aykırı içerikleri inceleme, kaldırma, yayından alma veya erişimi sınırlandırma hakkını saklı tutar."}]'::jsonb,
  false,
  null
),
(
  ...
  '[{"title":"Yayınlama Açık Rızası","body":"Vitrin oluştururken paylaştığım mağaza adı, açıklama, kategori, adres, konum, iletişim, sosyal bağlantılar, logo, galeri, ürün, hizmet ve çalışma saatlerinin VixRex üzerindeki dijital vitrinimde müşterilere açık şekilde yayınlanmasına açık rıza veriyorum."},{"title":"Tercih ve Geri Çekme","body":"Bu rızayı vermediğimde yerel taslağımı düzenleyebileceğimi ancak herkese açık vitrin yayınlayamayacağımı; verdiğim rızayı daha sonra geri çekerek vitrini yayından kaldırabileceğimi biliyorum."}]'::jsonb,
  false,
  null
),
(
  ...
  '[{"title":"Silme Talebi","body":"Hesap veya vitrin verilerinizin silinmesi için privacy@VixRex.app adresine talep gönderebilirsiniz."},{"title":"Rızayı Geri Çekme","body":"Yayınlama rızasını geri çektiğinizde vitrin yayından kaldırılır. Verilerin tamamen silinmesi için ayrıca veri silme talebi oluşturabilirsiniz."}]'::jsonb,
  false,
  null
)
