-- get_owner_workspace_bootstrap içindeki son mesaj sorgusu, aggregate ile
-- aynı seviyede `order by m.seq` kullandığı için PostgreSQL 42803 veriyordu.
-- Son 20 mesajı önce alt sorguda seçip ardından kronolojik JSON dizisine
-- çeviriyoruz. Fonksiyonun sahiplik ve çıktı sözleşmesi değişmez.
