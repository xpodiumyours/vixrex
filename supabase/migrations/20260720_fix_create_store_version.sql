-- ============================================================================
-- Aşama 5-DÜZELTME: create_store_with_token'a product_storage_version ekle
--
-- Sorun: Yeni mağazalar version=1 ile oluşturuluyor çünkü:
--   1. Column default'u hâlâ 1
--   2. create_store_with_token INSERT listesinde bu kolon yok
--
-- Çözüm:
--   1. Column default'u 2 yap
--   2. create_store_with_token'a product_storage_version=2 ekle
--   3. Mevcut mağazalar ETKİLENMEZ (62 eski mağaza version=1 kalır)
-- ============================================================================
...
-- 2. create_store_with_token'a product_storage_version ekle
