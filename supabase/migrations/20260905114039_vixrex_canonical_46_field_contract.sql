...
as $$
  select case pg_catalog.btrim(coalesce(p_field_key, ''))
    ...
    when 'urunBolumBaslik' then '{"fieldKey":"urunBolumBaslik","column":"product_section_title","type":"metin","required":false,"minLength":null,"maxLength":60,"min":null,"max":null,"options":null,"validation":null,"emptyValues":null}'::jsonb
    ...
    when 'galeriAksiyonLinki' then '{"fieldKey":"galeriAksiyonLinki","column":"gallery_action_href","type":"url","required":false,"minLength":null,"maxLength":null,"min":null,"max":null,"options":null,"validation":"ic_baglanti","emptyValues":null}'::jsonb
