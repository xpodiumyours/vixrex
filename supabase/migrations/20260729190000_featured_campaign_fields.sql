-- Dilim D: öne çıkan kampanya etiketi + yayın RPC alanları.

ALTER TABLE public.stores
  ADD COLUMN IF NOT EXISTS featured_banner_label TEXT;

COMMENT ON COLUMN public.stores.featured_banner_label IS
  'Öne çıkan kampanya bandı etiketi (örn. Yeni Sezon).';
