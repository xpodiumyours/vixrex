...
begin
  ...
  set
    ...
    privacy_notice_acknowledged = pg_catalog.coalesce((p_store->>'privacy_notice_acknowledged')::boolean, privacy_notice_acknowledged),
    privacy_notice_version = pg_catalog.coalesce(p_store->>'privacy_notice_version', privacy_notice_version),
    privacy_notice_hash = pg_catalog.coalesce(p_store->>'privacy_notice_hash', privacy_notice_hash),
    terms_accepted = pg_catalog.coalesce((p_store->>'terms_accepted')::boolean, terms_accepted),
    terms_version = pg_catalog.coalesce(p_store->>'terms_version', terms_version),
    terms_hash = pg_catalog.coalesce(p_store->>'terms_hash', terms_hash),
    publication_consent_accepted = pg_catalog.coalesce((p_store->>'publication_consent_accepted')::boolean, publication_consent_accepted),
    publication_consent_version = pg_catalog.coalesce(p_store->>'publication_consent_version', publication_consent_version),
    publication_consent_hash = pg_catalog.coalesce(p_store->>'publication_consent_hash', publication_consent_hash),
