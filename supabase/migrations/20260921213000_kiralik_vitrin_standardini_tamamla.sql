...
BEGIN
  ...
  WHERE slug IN ('kiralik-teknik','demo-lezzet-duragi','demo-nova-kuafor','demo-aymira-giyim')
    AND is_demo = true AND is_published = true;
  IF v_count <> 4 THEN
...
WHERE slug = 'kiralik-teknik' AND is_demo = true AND is_published = true;
...
WHERE slug = 'demo-lezzet-duragi' AND is_demo = true AND is_published = true;
...
WHERE slug = 'demo-nova-kuafor' AND is_demo = true AND is_published = true;
...
WHERE slug = 'demo-aymira-giyim' AND is_demo = true AND is_published = true;
