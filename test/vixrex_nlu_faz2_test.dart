...
void main() {
  group('Faz 2 – 8 kalite alan sözlük ve niyet', () {
    ...
    test('kalite alanlar niyetle tanınır', () {
      expect(
        resolver.resolve('Rozeti Kadıköyün En İyisi yap')?.anahtar,
        'heroRozet',
      );
      expect(
        resolver.resolve('Logoyu https://a.com/logo.png yap')?.anahtar,
        'logo',
      );
      expect(
        resolver.resolve('Kapak görselini https://a.com/cap.jpg yap')?.anahtar,
        'kapakGorseli',
      );
      ...
      expect(
        resolver
            .resolve('Harita linkini https://maps.google.com/?q=test yap')
            ?.anahtar,
        'haritaLinki',
      );
      expect(
        resolver.resolve('Hakkımızda başlığını Biz Kimiz yap')?.anahtar,
        'hakkindaBaslik',
      );
      expect(
        resolver
            .resolve('Hakkımızda yazısını Merhaba biz 10 yıldır yapıyoruz yap')
            ?.anahtar,
        'hakkindaMetin',
      );
    });
    ...
    test('kalite alan değer ayıklama', () {
      ...
      expect(
        extractor.extract(
          'Rozeti \'Kadıköyün En İyisi\' yap',
          vixrexNiyetAlanByAnahtar['heroRozet']!,
        ),
        'Kadıköyün En İyisi',
      );
      expect(
        extractor.extract(
          ...
          vixrexNiyetAlanByAnahtar['mahalle']!,
        ),
        'Caddebostan',
      );
      expect(
        extractor.extract(
          'Harita linkini https://maps.google.com/?q=test yap',
          vixrexNiyetAlanByAnahtar['haritaLinki']!,
        ),
      ...
      expect(
        extractor.extract(
          ...
          vixrexNiyetAlanByAnahtar['calismaSaatleri']!,
        ),
        '09:00-18:00',
      );
      expect(
        extractor.extract(
          'Logoyu https://a.com/logo.png yap',
          vixrexNiyetAlanByAnahtar['logo']!,
        ),
  ...
  group('Faz 2 – validator kalite', () {
    ...
    test('haritaLinki url', () {
      ...
      expect(
        VixrexFieldValidator.validate(alan, 'https://maps.google.com').ok,
        true,
      );
    ...
    test('logo gorsel url', () {
      ...
      expect(
        VixrexFieldValidator.validate(alan, 'https://a.com/logo.png').ok,
        true,
      );
      expect(
        VixrexFieldValidator.validate(alan, 'ftp://a.com/logo.png').ok,
        false,
      );
    });
    ...
    test('hakkindaBaslik max 90, hakkindaMetin max 1200', () {
      expect(
        VixrexFieldValidator.validate(
          vixrexNiyetAlanByAnahtar['hakkindaBaslik']!,
          'a' * 91,
        ).ok,
        false,
      );
      expect(
        VixrexFieldValidator.validate(
          vixrexNiyetAlanByAnahtar['hakkindaMetin']!,
          'a' * 1201,
        ).ok,
        false,
      );
  ...
  group('Faz 2 – executor kalite', () {
    test(
      'mahalle, haritaLinki, calismaSaatleri, heroRozet, hakkindaMetin/Baslik, logo, kapakGorseli yazılır',
      () {
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['mahalle']!,
            deger: 'Caddebostan',
          ),
          true,
        );
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['haritaLinki']!,
            deger: 'https://maps.google.com',
          ),
          true,
        );
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['calismaSaatleri']!,
            deger: '09:00-18:00',
          ),
          true,
        );
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['heroRozet']!,
            deger: 'En İyi',
          ),
          true,
        );
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['hakkindaBaslik']!,
            deger: 'Biz Kimiz',
          ),
          true,
        );
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['hakkindaMetin']!,
            deger: 'Hikaye',
          ),
          true,
        );
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['logo']!,
            deger: 'https://a.com/l.png',
          ),
          true,
        );
        ...
        expect(
          exec.execute(
            controller: c,
            alan: vixrexNiyetAlanByAnahtar['kapakGorseli']!,
            deger: 'https://a.com/c.jpg',
          ),
          true,
        );
    ...
    test('il/ilce özel akış – execute false', () {
      ...
      expect(
        exec.execute(
          controller: c,
          alan: vixrexNiyetAlanByAnahtar['il']!,
          deger: 'İstanbul',
        ),
        false,
      );
      expect(
        exec.execute(
          controller: c,
          alan: vixrexNiyetAlanByAnahtar['ilce']!,
          deger: 'Kadıköy',
        ),
        false,
      );
