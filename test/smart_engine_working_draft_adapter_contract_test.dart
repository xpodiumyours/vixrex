...
void main() {
  test('Supabase assistant adapter 5.5 authoritative RPC + permanent auth kullanır', () {
    final source = _read(
  ...
  test('assistant queue actionId/commandId/version kimliklerini kalıcı tutar', () {
    final source = _read(
    ...
    expect(source, contains('WorkingDraftAssistantPatchResult.queuedOffline'));
