...
void main() {
  testWidgets('Preview WhatsApp FAB geçersiz numarada açıklayıcı uyarı verir', (
    ...
    expect(
      find.text('Geçerli bir Türkiye cep telefonu numarası girin. Örn: 0555 123 45 67'),
      findsOneWidget,
    );
  });

  testWidgets('Preview WhatsApp FAB isDemo=true modunda bilgilendirme snackbarı gösterir', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    expect(
      find.text("Müşterileriniz bu butona bastığında '0555 123 45 67' numaralı WhatsApp hattınıza yönlendirilir."),
      findsOneWidget,
    );
  });
