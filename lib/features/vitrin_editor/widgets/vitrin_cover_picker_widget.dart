...
/// Vitrin kapak fotoğrafı seçici widget'ı.
/// Kapak fotoğrafını gösterir ve tıklandığında [onPickCover] callback'ini çağırır.
class VitrinCoverPickerWidget extends StatelessWidget {
