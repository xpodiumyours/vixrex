...
const List<VixRexIntentSemasi> vixRexIntentSemasi = [
  VixRexIntentSemasi(
    payload: 'merhaba',
    anahtarKelimeler: ['merhaba', 'selam', 'nasil', 'baslat', 'baslayalim', 'yardim', 'ne yapabilirsin', 'geri don', 'geri'],
  ),
  VixRexIntentSemasi(
    payload: 'vitrin_kurulum',
    anahtarKelimeler: ['sifirdan olustur', 'sifirdan', 'kendim olustur', 'yeni vitrin', 'vitrin kur', 'vitrin olustur'],
  ),
  VixRexIntentSemasi(
    payload: 'vixrex_info',
  ...
  VixRexIntentSemasi(
    payload: 'qr',
    anahtarKelimeler: ['qr', 'kod', 'kodumu goster', 'link', 'paylas', 'baglanti', 'url'],
  ),
  VixRexIntentSemasi(
    payload: 'randevu',
    anahtarKelimeler: ['randevu', 'rezervasyon', 'saat', 'takvim', 'musteri kabul', 'kategori'],
  ),
  VixRexIntentSemasi(
    payload: 'whatsapp',
  ...
  VixRexIntentSemasi(
    payload: 'yayinla',
    anahtarKelimeler: ['yayinla', 'canli', 'aktif', 'yayinda', 'goster', 'acik', 'yasal', 'onay'],
  ),
  VixRexIntentSemasi(
    payload: 'ocr_scan',
...
const Map<String, String> vixRexMesajlari = {
  ...
  'niyet_kategori_aciklama': 'İşine uygun hazır vitrinleri Keşfet\'ten göstereyim.',
  'niyet_geri_buton': '‹ Geri',
  'niyet_anlat_buton': 'Anlat ve devam et',
  'niyet_serbest_yertutucu': 'İşini birkaç cümleyle anlat (opsiyonel) — WhatsApp\'ını, adresini, çalışma saatlerini yazarsan, vitrinini seçtiğinde otomatik dolduracağım.',
  'niyet_ack': 'Anlattıklarını not aldım — vitrinini seçtiğinde bunlardan otomatik dolduracağım.',
  'hesap_bagla_baslik': 'Vitrinini hesabına bağla',
  'hesap_bagla_aciklama': 'Şu an vitrinin bu cihaza bağlı. Telefonunu değiştirirsen ya da tarayıcı verilerini silersen erişimini kaybedersin.',
  ...
  'nlu_kisa_onay_basari': 'Kaydettim ✅',
  'nlu_kisa_onay_iptal': 'Tamam, kaydetmedim. Başka nasıl yardımcı olabilirim?',
  'nlu_kisa_erisim_yok': 'Asistan şu an yanıt veremiyor. Lütfen biraz sonra tekrar dene.',
};
