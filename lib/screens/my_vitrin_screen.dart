...
class MyVitrinScreenState extends State<MyVitrinScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                'Mevcut Ürün: ${_data.products.length}',
                style: const TextStyle(
              ...
              ElevatedButton(
                onPressed: _showProductManagementPlaceholder,
                style: ElevatedButton.styleFrom(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 18),
                    _buildXrexCatalogAssistantSection(),
                    const SizedBox(height: 18),
                    Expanded(
                      child: products.isEmpty
                          ? _buildManagementEmptyState()
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return _buildManagementProductItem(product);
                              },
                            ),
                    ),
                    const SizedBox(height: 16),
                    ElevatedButton.icon(
                      onPressed: () {
                        _showPlaceholderSnackBar('Ürün ekleme özelliği bir sonraki pakette aktif edilecek.');
                      },
  ...
  Widget _buildManagementEmptyState() {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(
  ...
  Widget _buildManagementProductItem(Product product) {
            ...
            child: SizedBox(
              ...
              child: hasImage
                  ? Image.network(
                      product.imagePath!,
                      fit: BoxFit.cover,
                      errorBuilder: (_, __, ___) => _buildManagementItemFallback(),
                    )
                  : _buildManagementItemFallback(),
            ),
          ),
          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () {
                  _showPlaceholderSnackBar('Düzenleme özelliği bir sonraki pakette aktif edilecek.');
                },
                tooltip: 'Düzenle',
              ),
              IconButton(
                ...
                onPressed: () {
                  _showPlaceholderSnackBar('Silme özelliği bir sonraki pakette aktif edilecek.');
                },
                tooltip: 'Sil',
              ),
            ],
  ...
  Widget _buildManagementItemFallback() {
    return Container(
      color: AppColors.surface,
      child: const Center(
        child: Icon(
  ...
  Widget _buildXrexCatalogAssistantSection() {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: AppColors.surfaceSoft,
  ...
  Widget _buildXrexCatalogActionTile({
    required IconData icon,
    required String title,
    required String desc,
  }) {
    return InkWell(
      onTap: _showXrexCatalogComingSoon,
      borderRadius: BorderRadius.circular(12),
      child: Container(
        width: 146,
        padding: const EdgeInsets.all(10),
  ...
  void _showXrexCatalogComingSoon() {
    _showPlaceholderSnackBar('X-rex katalog çıkarma özelliği bir sonraki aşamada aktif edilecek.');
  }
}
