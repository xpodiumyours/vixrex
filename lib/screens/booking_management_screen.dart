          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: const Text(
                  'Randevunun onaylandığını müşteriye bildir.',
                ),
                onTap: () {
                  Navigator.pop(context);
                  _sendWhatsApp(
                    appt,
                    WhatsAppLinkHelper.appointmentConfirmTemplate,
                  );
                },
              ),
              const Divider(),
              ListTile(
                ...
                subtitle: const Text(
                  'Randevunun onaylanamadığını müşteriye bildir.',
                ),
                onTap: () {
                  Navigator.pop(context);
                  _sendWhatsApp(
                    appt,
                    WhatsAppLinkHelper.appointmentRejectTemplate,
                  );
                },
              ),
              const Divider(),
              ListTile(
                ...
                subtitle: const Text(
                  'Yeni bir saat belirlemek üzere iletişime geçin.',
                ),
                onTap: () {
                  Navigator.pop(context);
                  _sendWhatsApp(
                    appt,
                    WhatsAppLinkHelper.appointmentRescheduleTemplate,
                  );
                },
              ),
            ],
