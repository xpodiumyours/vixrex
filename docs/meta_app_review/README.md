...
This directory contains the documentation and guidelines required for the Meta App Review process for **VixRex**.
...
- `instagram_graph_user_media`: To list the user's media (images/videos/captions) so they can select and import them as products on their VixRex store.
