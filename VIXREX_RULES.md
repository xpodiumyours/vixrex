...
- **Değişmez kural — sahip düzenlemesi Next.js sahip panelinde yapılır:** Sahibin vitrinini düzenlediği yüzey Next.js'teki sahip panelidir. Bu panelin **iki kapısı** vardır ve ikisi de aynı alan şemasına bakar, aynı doğrulamadan geçer, aynı çalışma taslağına yazar: (1) **form** — vitrindeki alana tıklanır, kutu açılır; (2) **Vixrex Asistan** — sohbete yazılır, asistan aynı alanı günceller. Aynı alan için ikinci bir kayıt yolu açılmaz. Düzenlenebilir alanların tek kaynağı `docs/vitrin-alan-semasi.md` dosyasıdır; yeni alan önce oraya yazılır, sonra koda geçer.
